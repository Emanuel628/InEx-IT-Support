...
export const mockResolutions: ResolutionRecord[] = [
  {
    ...
    verificationSteps: ['Open receipts page as the affected business owner.', 'Confirm uploads proceed without missing context errors.'],
  ...
  },
  {
    ...
    verificationSteps: ['Run migration on production-shaped data.', 'Confirm schema completes without syntax error.'],
  ...
  {
    id: 'RES-4003',
    title: 'Restored secure export public key and worker config path',
    problemSummary: 'Secure export flow failed because export key availability and worker configuration were not aligned.',
    rootCause: 'Export hardening release left worker environment and key path expectations out of sync.',
    fixApplied: 'Repaired worker env setup and restored export public key availability checks.',
    filesOrAreasTouched: ['exports route', 'pdf worker env', 'crypto config'],
    commandsUsed: ['verify worker envs', 'retest export public key', 'run staged export'],
    verificationSteps: ['Call export public key endpoint.', 'Run staged secure export.', 'Confirm worker responds successfully.'],
    rollbackNotes: 'Rollback only if the worker path becomes unstable again after config sync.',
    relatedTicketIds: ['INC-1036'],
    relatedErrorIds: ['ERR-5001', 'ERR-5002'],
    relatedIncidentId: 'INCIDENT-2001',
    relatedReleaseId: 'REL-3004',
    relatedKnowledgeArticleIds: [],
    createdAt: '2026-04-10 10:10',
    updatedAt: '2026-04-10 10:30',
    tags: ['exports', 'worker', 'crypto'],
  },
];